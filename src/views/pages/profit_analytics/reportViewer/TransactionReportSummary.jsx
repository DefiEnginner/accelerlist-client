...
export default class TransactionReportSummary extends React.Component {
            ...
            <div className="row">
              <div className="col-lg-2">
                ...
                <p>
                  ...
                  >
                    ${parseInt(this.props.aggregatedReport.dailyNetProfit, 10)}
                    /day
                  </strong>
                  .
                </p>
              ...
              <div className="col-lg-12">
                <h4>
                  ...
                  <a
                    ...
                    onClick={e => {
                      e.preventDefault();
                      this.props.setDashboard.bind(null, "Insights")
                    }}
                  >
                    DEEPER INSIGHTS
                  </a>{" "}
                  ...
                  <a
                    ...
                    onClick={e => {
                      e.preventDefault();
                      this.props.setDashboard.bind(null, "Statement")
                    }}
                  >
                    INCOME STATEMENT
                  </a>
