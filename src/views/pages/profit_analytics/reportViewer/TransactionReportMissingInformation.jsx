            ...
            <div className="col-lg-12" style={{ textAlign: "left" }}>
              <p style={{ marginLeft: "10px" }}>
                ...
                <strong className="text-danger">
                  {
                    this.props.aggregatedReport.rowsMissingBuyCostOrSupplier
                      .length
                  }{" "}
                  SKUs
                </strong>{" "}
                missing either supplier or buy cost information. Please set that
                information here for the most accurate analytics possible!
              </p>

              <CSVLink
                data={this.props.aggregatedReport.rowsMissingBuyCostOrSupplier}
                filename={"skus_missing_information.csv"}
                headers={[
                  { label: "SellerSKU", key: "sku" },
                  { label: "Cost/Unit", key: "buy_cost" },
              ...
              <button
                ...
                onClick={this.props.saveAndRecalculate.bind(
                  null,
                  this.state.editsBySku
                )}
              >
              ...
              >
                <button
                  className="btn btn-primary pull-right margin-right"
                  style={{
                    fontWeight: 300,
                    fontFamily: "Open Sans",
                    marginLeft: "10px"
