  ...
  render() {
    ...
    return (
      ...
      >
          ...
          <option key="limit_3" selected={limit === 15} value="15">15</option>
          <option key="limit_4" selected={limit === 50} value="50">50</option>
          <option key="limit_5" selected={limit === 100} value="100">100</option>
      </Input>	
    );
  }
}
